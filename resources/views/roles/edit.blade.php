      ...
      <div class="element-box">
        ...
        @csrf
          ...
          <div class="row">
                                        ...
                                        <?php $sel_per = array(); ?>
                                        @foreach($selper as $per)
                                        <?php array_push($sel_per,$per->id); ?>
                                        @endforeach
                                    </div>
                                                ...
                                                <div id="accordion" class="mb-4">
                                                    <div class="accordion">
                                                        <div class="accordion-header" role="button" data-toggle="collapse" data-target="#panel-body-{{ $perm->module_id }}" aria-expanded="true">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <h4>{{ $perm->module_title.' - (Permissions)' }}</h4>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-3 col-form-label">
                                                                            <div class="form-check">
                                                                                @if(in_array($perm1->id,$sel_per))
                                                                                    <input class="form-check-input" name="permission_id[]" id="permission_id" checked value="{{ $perm1->id }}" type="checkbox">
                                                                                @else
