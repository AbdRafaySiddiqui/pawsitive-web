  ...
  <div class="element-box-tp">
    ...
    <div class="element-box-tp">
      ...
      <div class="controls-above-table">
        <div class="row">
          <div class="col-sm-6">
            <a class="btn btn-sm btn-secondary" href="#">Download CSV</a><a class="btn btn-sm btn-secondary" href="{{route('breeds.create')}}">Add Breeds</a><a class="btn btn-sm btn-danger" href="#">Delete</a>
          </div>
          <div class="col-sm-6">
          ...
          @foreach ($breed as $breeds)
            <tr>
              ...
              <td class="row-actions">
                <a href="{{route('breeds.edit',$breeds->id)}}"><i class="os-icon os-icon-ui-49"></i></a><a href="#"><i class="os-icon os-icon-grid-10"></i></a>
