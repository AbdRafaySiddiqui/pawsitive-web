                                            ...
                                            <select class="form-control select2" name="event_id" id="event_id">
                                                ...
                                                @foreach ($Events as $Event)
                                                    <option value="{{ $Event->id }}">
                                                        {{ $Event->name }} |
                                                        {{ isset($Event->club_name->name) ? '(' . $Event->club_name->name . ')' : '' }}
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="date" id="event-date"
                                                        type="date">
                                                </div>
                                            </div>

                                            <input class="form-control" style="display: none;" name="date" id="club-id"
                                                placeholder="Enter Club" type="text">
                                            <input class="form-control" style="display: none;" name="date" id="judge-id"
                                                placeholder="Enter Judge" type="text">
                                            <input class="form-control" style="display: none;" name="date" id="country"
                                                placeholder="Enter country" type="text">

                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="">Club Name</label>
                                                    <input class="form-control" name="date" id="club-name"
                                                        placeholder="Enter Club" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="date" id="judge-name"
                                                        placeholder="Enter judge" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="date" id="country-name"
                                                        placeholder="Enter country" type="text">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="class" id="class"
                                                        placeholder="Enter class" type="text">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" onchange="dogs_by_judge(this)"
                                                        name="breed_id" id="breed_ide">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td id="col0">
                                                                ...
                                                                <!-- <div class="col-md-12"> -->
                                                                <select class="form-control select2 dog" name="dog_id[]"
                                                                    id="all_dogs" onchange="verify_if_dog(this)">
                                                                    <option value="0">
                                                                        Select Dog
                                                                    </option>
                                                                </select>
                                                            ...
                                                            <td id="col1">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" name="grading[]"
                                                            ...
                                                            <td id="col3">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" name="awards[]"
                                                                        placeholder="Enter Awards" type="text">
                                                                </div>
                                                            </td>
                                                            <td id="col4">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <select class="form-control select2 select_judge"
                                                                        name="judge[]" id="judge">
                                                                    ...
                                                                    <span class="form-control span_judge" id="judge_span"
                                                                        name="judge[]"></span>
                ...
                <div class="modal-body">
                    <form id="my-form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input id="dog_name" class="form-control" name="dog_name" placeholder="Enter Dog Name"
                                    type="text">
                            </div>
                        </div>
                        <div class="form-group row">
    ...
    <script type="text/javascript">
        ...
        $('#add').click(function(e) {
            ...
            for (var i = 0; i <= cellCount; i++) {
                ...
                if(document.getElementById('col' + i).innerHTML)
                {
                    $('#col0 select').attr("id", "all_dogs_"+rowCount);
                    var copycel = document.getElementById('col' + i).innerHTML;
                    cell.innerHTML = copycel;
                }
                console.log(document.getElementById('col' + i).innerHTML, "col"+i);
            }

            $('#all_dogs_'+rowCount).select2();
        });
