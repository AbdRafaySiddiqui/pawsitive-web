                                    ...
                                    <tbody>
                                        <tr>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <select class="form-control  js-data-example-ajax"
                                                            name="inputs[0]['dog_id']" id="all_dogs">
                                                            @foreach ($dogs as $dog)
                                                                <option value="{{ $dog->id }}">
                                                                    {{ $dog->dog_name }}
                                                                </option>
                                            ...
                                            <td>
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="inputs[0]['grade']"
                                            ...
                                            <td class="text-right">
                                                <div class="form-group row">
                                                    <div class="col-sm-12">
                                                        <input class="form-control" name="inputs[0]['place']"
                        ...
                        <div class="modal-body">
                            <form id="my-form">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="dog_name" class="form-control" name="dog_name"
                                            placeholder="Enter Dog Name" type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
            ...
            <script type="text/javascript">
                ...
                $('#add').click(function() {
                    ...
                    $('#table').append(
                        `<tr>
                          <td>
                            <select class="form-control js-data-example-ajax" name="inputs[` + i + `][dog_id]" id="all_dogs">          
                              @foreach ($dogs as $dog)
                          ...
                          <td>
                            <input class="form-control" name="inputs[` + i + `][grade]" placeholder="Enter Grade" type="text" />
                          </td>
                          <td>
                            <input class="form-control" name="inputs[` + i + `][place]" placeholder="Enter place" type="text" />
                          </td>
                          <td>
                            <select class="form-control js-data-example-ajax" name="inputs[` + i + `][judge]" id="judge">
                              @foreach ($total_judges as $judge)
