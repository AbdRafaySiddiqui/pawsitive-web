...
@section('content')
    ...
    <div class="content-i">
        <div class="content-box">
          ...
          -------------------->
                        <div class="controls-above-table" id="dataTable1_filter" class="dataTables_filter">
                            <div class="row">
                                <div class="col-sm-6">
          ...
          ------------------  -->
                        <div class="table-responsive">
                            <table id="dataTable1" class="table table-bordered table-lg table-v2 table-striped">
                                <thead>
                                    <tr>
                                        <th>
                                            Club Name
