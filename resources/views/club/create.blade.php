                        ...
                        <div class="element-wrapper">
                            ...
                            <div class="element-box">
                                <form action="{{ route('club.store') }}" method="post">
                                    ...
                                    <div class="form-desc">
                                        Discharge best employed your phase each the of shine. Be met even reason consider
                                        logbook redesigns. Never a turned interfaces among asking
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label" for="">Club Name</label>
                                        <div class="col-sm-8">
                                            <input class="form-control" name="name" placeholder="Club Name"
                                                type="text">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-4" for="" name="countries">
                                            Countries</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-sm-4" for="" name="affiliation">
                                            Affiliation with</label>
                                        <div class="col-sm-8">
                                            <input class="form-control" name="affiliation" placeholder="Affiliation with"
                                                type="text">
                                        </div>
                                    </div>
